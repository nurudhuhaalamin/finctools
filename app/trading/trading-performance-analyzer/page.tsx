...
export const metadata: Metadata = {
  title: 'Trading Performance Analyzer | FincTools',
  description: 'Analisis statistik performa trading: win rate, profit factor, expectancy, dan total P/L.',
}
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        <nav className="flex items-center gap-1 text-xs text-[--text-secondary] mb-6">
          ...
          <ChevronRight size={12} />
          <span className="text-[--text-primary] font-medium">Trading Performance Analyzer</span>
        </nav>
        <div className="mb-8">
          ...
          <h1 className="font-heading text-2xl md:text-3xl font-bold text-[--text-primary] mb-2">Trading Performance Analyzer</h1>
          <p className="text-[--text-secondary] leading-relaxed max-w-xl">Analisis statistik performa trading: win rate, profit factor, expectancy, dan total P/L.</p>
        </div>
        ...
        <div className="finc-card bg-slate-50 dark:bg-slate-900/50">
          ...
          <div className="flex flex-wrap gap-2">
            {related.filter(t => !t.href.includes('trading-performance-analyzer')).slice(0,4).map(t => (
