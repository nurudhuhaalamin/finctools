...
export const metadata: Metadata = {
  title: 'Trade Analyzer | FincTools',
  description: 'Analisis kelayakan trade berdasarkan Risk/Reward ratio. Hitung potensi profit dan loss sebelum eksekusi.',
}
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-heading text-2xl md:text-3xl font-bold text-[--text-primary] mb-2">Trade Analyzer</h1>
          <p className="text-[--text-secondary] leading-relaxed max-w-xl">Analisis kelayakan trade berdasarkan Risk/Reward ratio. Hitung potensi profit dan loss sebelum eksekusi.</p>
        </div>
        ...
        <div className="finc-card bg-slate-50 dark:bg-slate-900/50">
          ...
          <div className="flex flex-wrap gap-2">
            {related.filter(t => !t.href.includes('trade-analyzer')).slice(0,4).map(t => (
