...
export const metadata: Metadata = { title: 'Entry Price Optimizer | FincTools', description: 'Tentukan lot optimal berdasarkan modal, risiko per trade, stop loss, dan target profit.' }
export default function Page() {
  return (<><Header /><main className="mx-auto max-w-4xl px-4 py-8">
    <nav className="flex items-center gap-1 text-xs text-[--text-secondary] mb-6"><Link href="/" className="hover:text-finc-green">Home</Link><ChevronRight size={12}/><Link href="/saham" className="hover:text-finc-green">Saham</Link><ChevronRight size={12}/><span className="text-[--text-primary] font-medium">Entry Price Optimizer</span></nav>
    <SahamToolPage name="Entry Price Optimizer" description="Tentukan lot optimal berdasarkan modal, risiko per trade, stop loss, dan target profit."
    ...
    ><EntryPriceOptimizer /></SahamToolPage>
  </main><Footer /></>)
}
