    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="space-y-4">
        ...
        <div className="finc-card space-y-3">
          {[['Max Cicilan KPR/bulan',fmt(r.maxCicilanKPR)],['Max Pinjaman',fmt(r.maxPinjaman)],['DP yang Dibutuhkan',fmt(r.dpDibutuhkan)],['Debt-to-Income Ratio',`${r.dtiRatio}%`]].map(([l,v])=>(
